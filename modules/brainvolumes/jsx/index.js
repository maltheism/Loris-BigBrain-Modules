...
const BrainVolumes = () => {
  ...
  const data = [
    ...
    ['MNI ICBM 152 Space (ICBM 2009b Nonlinear Symmetric)', 'Full volume, 400um with optical balancing', '400um', 'isotropic (493x583x473)', '8-bit', 'gray scale unsigned short', '2013', '', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full8_400um_optbal_2009b_sym.mnc', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full8_400um_optbal_2009b_sym.nii.gz', '21 MB', '21 MB', ''],
    ['MNI ICBM 152 Space (ICBM 2009b Nonlinear Symmetric)', 'ICBM 2009b Symmetric Template', '500um', 'isotropic', '8-bit', 'gray scale unsigned byte', '2013', 'For more info, please see the BIC page', '', '', '', '', 'http://www.bic.mni.mcgill.ca/ServicesAtlases/ICBM152NLin2009'],
    // 7T syn24 template in MNI Space
    ['7T syn24 template in MNI Space', 'Full volume, 400um', '400um', 'isotropic (454x544x454)', '', 'float', '2013', 'See template "7T syn24 template, 400um"', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full-xz-avg9-pad20_n3_csffill_regSyn24_400um.mnc', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full-xz-avg9-pad20_n3_csffill_regSyn24_400um.nii.gz', '94 MB', '94 MB', ''],
    ['7T syn24 template in MNI Space', '7T syn24 template, 400um', '400um', 'isotropic (454x544x454)', '', 'float', '2013', 'This model is provided by the Max Planck Institute for Human Cognitive and Brain Sciences, Department of Neurophysics (contact: Dr. Pierre-Louis Bazin, bazin@cbs.mpg.de).', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/syn24-average-t1map-lvl2-10.mnc', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/syn24-average-t1map-lvl2-10.nii.gz', '104 MB', '104 MB', ''],
    // Histological Space
    ['Histological Space', 'Full volume, 100um without optical balancing', '100um', 'isotropic (1392x1541x1209)', '16-bit', 'gray scale unsigned short', '2013', '', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full16_100um.mnc', 'File too large', '1459 MB', '', ''],
    ['Histological Space', 'Full volume, 100um with optical balancing', '100um', 'isotropic (1392x1541x1209)', '16-bit', 'gray scale unsigned short', '2013', '', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full16_100um_optbal.mnc', 'File too large', '1486 MB', '', ''],
    ['Histological Space', 'Full volume, 200um without optical balancing', '200um', 'isotropic (696x770x605)', '16-bit', 'gray scale unsigned short', '2013', '', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full16_200um.mnc', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full16_200um.nii.gz', '188 MB', '187 MB', ''],
    ...
    ['Histological Space', 'Full volume, 100um without optical balancing', '100um', 'isotropic (1392x1541x1209)', '8-bit', 'gray scale unsigned byte', '2013', '', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full8_100um.mnc', 'File too large', '632 MB', '', ''],
    ['Histological Space', 'Full volume, 100um with optical balancing', '100um', 'isotropic (1392x1541x1209)', '8-bit', 'gray scale unsigned byte', '2013', '', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full8_100um_optbal.mnc', 'File too large', '634 MB', '', ''],
    ['Histological Space', 'Full volume, 200um without optical balancing', '200um', 'isotropic (696x770x605)', '8-bit', 'gray scale unsigned byte', '2013', '', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full8_200um.mnc', 'https://bigbrain-ftp.loris.ca/bigbrain-ftp/BigBrainRelease.2013/3D_Volumes/full8_200um.nii.gz', '83 MB', '82 MB', ''],
  ...
  const fields = [
    {
      ...
      filter: {
        ...
        type: 'select',
        options: {
          'MNI ICBM 152 Space': 'MNI ICBM 152 Space',
          'MNI ADNI Space': 'MNI ADNI Space',
          'Histological Space': 'Histological Space',
          'MNI ICBM 152 Space (ICBM 2009b Nonlinear Symmetric)': 'MNI ICBM 152 Space (ICBM 2009b Nonlinear Symmetric)',
          '7T syn24 template in MNI Space': '7T syn24 template in MNI Space',
        },
      },
    },
    {
  ...
  const formatColumn = (column, cell, rowData, rowHeaders) => {
    ...
    switch (column) {
      ...
      case 'NIFTI':
        ...
        break;
      case 'Resolution':
        if (rowData['ResolutionDescription'] !== '') {
          reactElement = (
            <td>{rowData['Resolution']} {rowData['ResolutionDescription']}</td>
          );
        }
        break;
      case 'Encoding':
        if (rowData['EncodingDescription'] !== '') {
          reactElement = (
            <td>{rowData['Encoding']} {rowData['EncodingDescription']}</td>
          );
        }
        break;
      case 'Comments':
