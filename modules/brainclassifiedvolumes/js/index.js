window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["brainclassifiedvolumes"] = window["lorisjs"]["brainclassifiedvolumes"] || {}; window["lorisjs"]["brainclassifiedvolumes"]["index"] =
...
var BrainClassifiedVolumes = function BrainClassifiedVolumes() {
  // data for filter table.
  var data = [// MNI ICBM 152 Space (ICBM 2009b Nonlinear Symmetric)
  ['Full Classified Volume, 100um', '100um isotropic (1970x2330x1890)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/MNI-ICBM152_Space/full_cls_100um_2009b_sym.mnc'], ['Full Classified Volume, 200um', '200um isotropic (985x1165x945)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/MNI-ICBM152_Space/full_cls_200um_2009b_sym.mnc'], ['Full Classified Volume, 300um', '300um isotropic (657x777x630)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/MNI-ICBM152_Space/full_cls_300um_2009b_sym.mnc'], ['Full Classified Volume, 400um', '400um isotropic (493x583x473)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/MNI-ICBM152_Space/full_cls_400um_2009b_sym.mnc'], ['Full Classified Volume, 1000um', '1000um isotropic (TODO)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/MNI-ICBM152_Space/full_cls_1000um_2009b_sym.mnc'], // Histological Space
  ['Full Classified Volume, 100um', '100um isotropic (1970x2330x1890)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/Histological_Space/full_cls_100um.mnc'], ['Full Classified Volume, 200um', '200um isotropic (985x1165x945)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/Histological_Space/full_cls_200um.mnc'], ['Full Classified Volume, 300um', '300um isotropic (657x777x630)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/Histological_Space/full_cls_300um.mnc'], ['Full Classified Volume, 400um', '400um isotropic (493x583x473)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/Histological_Space/full_cls_400um.mnc'], ['Full Classified Volume, 400um', '1000um isotropic (493x583x473)', '8-bit unsigned byte', '', '', 'ftp://bigbrain.loris.ca/BigBrainRelease.2015/3D_Classified_Volumes/Histological_Space/full_cls_1000um.mnc']]; // fields configured for filter.
...
window.addEventListener('load', function () {
  ReactDOM.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(BrainClassifiedVolumes, {
    url: {
      base: loris.BaseURL
    }
